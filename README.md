...
```bash
SERVER_TOKEN="same_token_as_the_server" SERVER_URL="127.0.0.1:3000" SHARED_DIR="/home/user/files" cargo run -p client
```
...
- `SERVER_URL` - server address used by the client, defaults to `127.0.0.1:3000`.
